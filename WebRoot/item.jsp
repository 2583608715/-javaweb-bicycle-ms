  ...
  if(username==null&&chaoji==null&&putong==null){
    ...
    %>
                ...
                <body>
                    ...
                    <table style="border:1px solid #6daafc" cellspacing="5">
                        <tr>
                            <td>
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td width="350" align="left" height="20" border="0"><b>预定拿车时间:</b>
                                            <%=order.getCreate_date()  %>
                                        </td>
                                        <td width="350" align="left" height="20" border="0"><b>租期:</b>
                                            <%=order.getTime()  %>
                                        </td>
                                        <td width="350" align="left" height="20" border="0"><b>客户电话:</b>
                                            <%=order.getKehutel()  %>
                                        </td>
                                        <td width="350" align="left" height="20" border="0"><b>退还服务站:</b>
                                            <%= order.getServicer_name() %>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
			...
			%>
                                            <tr align="center">
                                                ...
                                                <td bgcolor="#d2e9ff" width="200" align="center" height="20">
                                                    <%= item.getBike().getName() %>
                                                </td>
                                                <td bgcolor="#d2e9ff" bgcolor="white" width="200" align="center" height="20">
                                                    <%=item.getBike().getServicer().getName() %>
                                                </td>
                                                <td bgcolor="#d2e9ff" bgcolor="white" width="200" align="center" height="20">￥
                                                    <%=item.getBike().getPrice()%>元</td>
                                                <td bgcolor="#d2e9ff" bgcolor="white" width="200" align="center" height="20">￥
                                                    <%=item.getBike().getYajin()%>元</td>
                                                <td bgcolor="#d2e9ff" bgcolor="white" width="200" align="center" height="20">
                                                    <%=item.getCount() %>
                                                </td>
                                            </tr>
