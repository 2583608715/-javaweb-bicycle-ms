            ...
            i++;%>
                                    <form action="ServicerServlet" method="post" name="mf" id="mf<%=i %>">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" name="serviceraddress" id="serviceraddress" value="<%=s.getAddress() %>" /></td>
                                            <td><input type="text" class="form-control" name="servicertel" id="servicertel" value="<%=s.getTel() %>" /></td>
                                            <td align="center" height="20">
                                                <input type="button" class="btn btn-black" value="修改" onclick="checkdd(document.getElementById('mf<%=i%>'),
                                                                 document.getElementById('action<%=i%>'));" />
                                            </td>
                                            <td>
                                                <input type="button" class="btn btn-danger" value="删除" onclick="delSubmit(document.getElementById('mf<%=i%>'),
                                                                  document.getElementById('action<%=i%>'));" />
                                            </td>
                                        </tr>
                                    </form>
